...
const createCommentNode = (comment) => {
  ...
  commentText.classList.add("commented-text");
  commentText.innerText = comment.text;

  const userImage = document.createElement("div");
  userImage.classList.add("comment-user-frame");
  ...
  commentNode.appendChild(userImage);
...
const addComment = () => {
  ...
  if (commentText === "") {
    alert("Comments cannot be empty, Please type in some comment before adding!");
    return;
  }
